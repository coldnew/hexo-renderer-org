...
** How can I add line-number on src-block ?
   ...
   [[https://github.com/coldnew/hexo-renderer-org][hexo-renderer-org]] provides two backend to render your code block, choose which backend you use:

*** For htmlize backend user

    If you are =htmlize= to render your src-block, you can add following to your =_config.yml= to make line-number display =globally=:
