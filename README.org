...
** I don't want to use emacs daemon
   ...
   #+BEGIN_SRC yaml
     org:
       ...
       daemonize: false
   #+END_SRC
** Can I drag and drop image to org-file ?

Yes, first you need to install [org-download](https://github.com/abo-abo/org-download) to your emacs.

Then add following to =.dir-localse.el= at the top of your hexo project:
